  ...
  return (
    ...
    >
      <Link href={`/category/${category.slug}`} className="block group h-full">
        <div className="p-5 rounded-2xl border border-[var(--border)] bg-[var(--card)] hover:bg-[var(--muted)] hover:border-[var(--border-strong)] transition-all duration-200 h-full flex flex-col min-h-[148px]">
